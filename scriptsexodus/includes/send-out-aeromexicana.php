...
$rs = $db->Execute($qry) or die("El mensaje no pudo ser enviado. Ll�manos!");
...
try {
  ...
  $mail->AddAddress($mail_contacto, $Ncomercial);
	$mail->AddAddress("ventas1@aeromexicanadeviajes.com", "Ventas1");
	$mail->AddAddress("ventas2@aeromexicanadeviajes.com", "Ventas2");
  //$mail->AddBCC("li.luisgarcia@gmail.com", "Luis Garc�a");
	//$mail->AddBCC("ventas1@aeromexicanadeviajes.com", "Ventas1");
	//$mail->AddBCC("ventas2@aeromexicanadeviajes.com", "Ventas2");
  $mail->AddBCC("info@exodus.mx", "Exodus Travel");
  //$mail->AddBCC("zcruz@meca.mx", $Ncomercial);


#  $mail->AddReplyTo('name@yourdomain.com', 'First Last');
  $mail->Subject = "Contacto desde su p�gina Exodus " . date('d-m-Y');
...
<p>Mensaje recibido a trav&eacute;s de su p�gina web Exodus</p>
