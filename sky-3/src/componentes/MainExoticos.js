    ...
    return (
        ...
        <div className="container">
            <div className="row">
                ...
                <iframe className="iframe-mega" title="exoticos" src="https://www.megatravel.com.mx/tools/vi.php?Dest=10&txtColor=333333&aColor=333333&ahColor=22a9bf&thBG=22a9bf&thTxColor=fff&ff=9" width="100%" height="1200" border="0"align="left" allowtransparency="true" frameborder="0"> </iframe>
                </div> 
            </div> 
        </div>   
        </section> 
