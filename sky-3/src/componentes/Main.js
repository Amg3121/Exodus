...
function Main({user}) {
		...
		<div className="slide">
				...
				{carousel1.map(c1 => (
					...
					<a href={'/detail/'+c1.mt+'/'+c1.name}>
						...
						<img className="slide_movil img-fluid" src={c1.img2} width="100%" alt=""/>
					</a>
	...
	<section className="mas-vendidos">
		<div className="container-template-slide">
			<h3 className="subtitle-section-black color-verde-subtitle">Mega Ofertas</h3>
          <h4 className="title-section-black">Mega Ofertas</h4>
          <hr className="divider margin-divider-one color-verde-line"/>
	...
	<section className="section-80 section-lg-120 section-agencia" id="about">
        <div className="container container-wide">
          <h3 className="subtitle-section-black color-verde-subtitle">Agencia de viajes en {user.state_name}, {user.city_name}</h3>
				<h4 className="title-section-black">{user.name_agency}</h4>
          <hr className="divider color-verde-line"/>
          <div className="row row-50">
            <div className="col-md-6 col-lg-4 icon-box view-animate text-center"><span className="icon icon-lg text-primary-grad icon-primary icon-circle mdi mdi-airplane color-verde-icon"></span>
              <h5 className="text-bold">Quienes<br className="d-none d-lg-block"/>Somos</h5>
              <hr className="divider-info color-verde-subline"/>
            ...
            <div className="col-md-6 col-lg-4 icon-box view-animate text-center"><span className="icon icon-lg text-primary-grad icon-primary icon-circle mdi mdi-account-multiple color-verde-icon"></span>
              <h5 className="text-bold">Redes Sociales <br/></h5>
              <hr className="divider-info color-verde-subline sociales-margin"/>
              <p className="inset-xxl-left-40 inset-xxl-right-40">Siguenos en nuestras redes sociales. ¡Dale Me Gusta!</p>
            </div>
            <div className="col-md-6 col-lg-4 icon-box view-animate text-center"><span className="icon icon-lg text-primary-grad icon-primary icon-circle mdi mdi-wechat color-verde-icon"></span>
          ...
          <div className="row justify-content-sm-center">
            <div className="col-xl-12 col-lg-12 wow fadeInUp">
              <h1 className="text-spacing-60 text-uppercase text-ubold2 p">¿Buscas una experiencia autentica?</h1>
				<p className="big">Nosotros creamos tus vacaciones soñadas</p><a className="button button-template btn-verde-purple btn-verde-purple-hover" href={'tel:'+user.phone}>Llama ahora:{user.phone}</a>
            </div>
          </div>
        </div>
      </section>
	...
	<section className="megatv">
		<h3 className="subtitle-section-black color-verde-subtitle">Videos que inspiran y enamoran</h3>
		<h4 className="title-section-black">Mega TV</h4>
		<hr className="divider color-verde-line"/>
		<div className="container">
			<div className="row">
				<div className="col-md-6 back-azul-verde padding-carrusel-videos">
					<h5 className="videos-online color-verde-line">Videos Online</h5>
	...
	<section className="traveler">
		<h3 className="subtitle-section-black color-verde-subtitle">Descrubre tu proximo destino</h3>
		<h4 className="title-section-black">Revista Traveler</h4>
		<hr className="divider color-verde-line"/>
		<div className="container">
			<div className="row">
			<div className="col-md-6">
				<span className="revista-online color-verde-line">Revista Online </span>
				<div className="fecha">
					{ traveler.title }<br/>
					{ traveler.date }
				</div>
				<a href={ traveler.url } target="_blank" className="button-descargar button-descargar-verde"> <span><i className="far fa-eye"></i></span> Ver</a>
				<a href={ traveler.descarga } target="_blank" className="button-descargar button-descargar-verde"><span><i className="fas fa-download"></i></span> Descargar</a>
			</div>
			<div className="col-md-6">
	...
	<section className="galeria">
		...
		<h3 className="subtitle-section-black color-verde-subtitle">Las mejores ofertas</h3>
	...
	<div className="row no-gutters">
		...
		<a className="thumbnail-variant-4" data-toggle="modal" data-target="#favoritos"><img className="img-responsive center-block thumbnail-image" src="https://exodus.b-cdn.net/exodus/sky/01/img/london.png" alt=""/>
					...
					<h3 className="text-ubold btn-verde-purple">{title3}</h3>
		...
		<a className="thumbnail-variant-4" data-toggle="modal" data-target="#bloqueos"><img className="img-responsive center-block thumbnail-image" src="https://exodus.b-cdn.net/exodus/sky/01/img/vegas.png" alt=""/>
					<div className="caption">
					  <h3 className="text-ubold btn-verde-purple">Seccion de viajes</h3>
					</div>
		</a>
		</div>
		</div>
		...
		<a className="thumbnail-variant-4" data-toggle="modal" data-target="#temporada"><img className="img-responsive center-block thumbnail-image" src="https://exodus.b-cdn.net/exodus/sky/01/img/fiordo.png" alt=""/>
					<div className="caption">
						<h3 className="text-ubold btn-verde-purple">{title4}</h3>
					</div>
		</a>
		</div>
		...
		<a className="thumbnail-variant-4" data-toggle="modal" data-target="#ofertas"><img className="img-responsive center-block thumbnail-image" src="https://exodus.b-cdn.net/exodus/sky/01/img/iguazu.png" alt=""/>
					<div className="caption">
					  <h3 className="text-ubold btn-verde-purple">Mega Ofertas</h3>
		...
		<a className="thumbnail-variant-4" data-toggle="modal" data-target="#bloqueos"><img className="img-responsive center-block thumbnail-image" src="https://exodus.b-cdn.net/exodus/sky/01/img/paris.png" alt=""/>
					<div className="caption">
					<h3 className="text-ubold btn-verde-purple">{title5}</h3>
		...
		<a className="thumbnail-variant-4" href="/mexico"><img className="img-responsive center-block thumbnail-image" src="https://exodus.b-cdn.net/exodus/sky/01/img/cancun.png" alt=""/>
						<div className="caption">
						  <h3 className="text-ubold btn-verde-purple">cancún</h3>
