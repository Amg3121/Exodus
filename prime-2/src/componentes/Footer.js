...
<section className="contacto" id="contacto">
                ...
                <div className="row container-count">
                    <div className="col-md-4 mb-3 mb-md-0">
                      <div className="card card-body shadow-sm h-100">
                        <div className="display-4 color-coral contacto-count  mb-3" >150</div>
                        <div className="contacto-count-text">Los mejores destinos nacionales</div>
                      </div>
                    </div>
                    <div className="col-md-4 mb-3 mb-md-0 ">
                      <div className="card card-body shadow-sm h-100">
                        <div className="display-4 color-coral contacto-count  mb-3" >2,500</div>
                        <div className="contacto-count-text">Destinos internacionales somos especialistas</div>
                      </div>
                    </div>
                    <div className="col-md-4 mb-3 mb-md-0 ">
                      <div className="card card-body shadow-sm h-100">
                        <div className="display-4 color-coral contacto-count  mb-3" >365</div>
                        ...
                        <div className="form-row">
                          <div className="col">
                            ...
                            <div className="d-flex justify-content-end">
                              <button className="btn-contacto btn-back-coral" type="submit" data-loading-text="Sending">
           ...
           <footer>
           <section className="mapa background-coral-gris">
            <div className="container-fluid padding-mapa">
                <section className="row no-gutters p-0">
                    ...
                    <div className="col-lg-6">
                      <div className="divider divider-side d-none d-lg-block transform-flip-y background-coral-gris"></div>
        ...
        <section className="footer background-coral">
