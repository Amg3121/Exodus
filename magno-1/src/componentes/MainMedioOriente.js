    ...
    <br/><br/><br/><br/><br/><br/>
        ...
        <div className="container">
            <div className="row">
                ...
                <iframe className="iframe-mega" title="mediooriente" src="https://www.megatravel.com.mx/tools/vi.php?Dest=2&txtColor=2D2C2C&aColor=2D2C2C&ahColor=9d25ba&thBG=9d25ba&thTxColor=FFF&ff=1" width="100%" height="1200" border="0"align="left" allowtransparency="true" frameborder="0"> </iframe>
                </div> 
            </div> 
        </div>   
        </section>
