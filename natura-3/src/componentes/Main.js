...
// -- Fin Mega en Vivo -- //
    ...
    return (
            ...
            <div className="container-template">
                <div className="row">
                    <div className="col-md-6">
                        <img src="https://exodus.b-cdn.net/exodus/natura/03/img/tucan.png" className="img-fluid" alt="agencia de viajes"/>
                    </div>
                    <div className="col-md-6">
                        ...
                        <a href="#contacto" className="btn-section-one btn-back-jungle">Quiero recibir asesoría</a>
                    </div>
                </div>
            </div>

            <div className="divider back-jungle-dark"></div>
        </section>

        <section className="confiarnos back-jungle-dark">
        ...
        <section className="salidas-programadas back-jungle-dark">
            <div className="container-template-slide">
        ...
        <section className="mega-ofertas mega-ofertas-back back-jungle-temporada">
            <div className="container-template-slide">
            ...
            <div className="container-template">
                <div className="row">
                    <div className="col-md-4">
                                ...
                                <a href="" data-toggle="modal" data-target="#exampleModal" className="btn-megatv btn-back-jungle">
                                    <span>
                                        <img src="https://exodus.b-cdn.net/exodus/natura/02/img/mega-tv.png" alt=""/>
                                    </span>MEGA TV
                                </a>
                                <a href="" data-toggle="modal" data-target="#exampleModal2" className="btn-megatv btn-back-jungle">
                                    <span>
    ...
    <div className="col-md-12">
      <div className="row">
        <div class="col-md-6">
          ...
          <a href={traveler.url} target="_blank" class="btn-megatv btn-back-jungle">
            <span><img src="https://exodus.b-cdn.net/exodus/natura/02/img/mega-tv.png" alt=""/>
            </span>VER</a>
          <a href={traveler.descarga} target="_blank" class="btn-megatv btn-back-jungle">
