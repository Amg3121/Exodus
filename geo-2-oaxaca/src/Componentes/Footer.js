...
<section className="contacto" id="contacto">
        ...
        <div className="direccion">
            ...
            <p className="parrafo-direccion">{user.address}, {user.outdoor_number} {user.suburb} CP. {user.postal_code} {user.city_name}, {user.state_name} </p>
        </div>
        ...
        <ul className="footer-redes-ul">
            ...
            { user.facebook  != null ? <li className="footer-redes-li">
                <a href={'https://www.facebook.com/'+user.facebook} target="_blank" className="footer-redes-a">
                    <img className="footer-redes-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/footer/facebook.png" alt=""/>
                </a>
                ...
                <a href={'https://twitter.com/'+user.twitter} target="_blank" className="footer-redes-a">
                    <img className="footer-redes-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/footer/twitter.png" alt=""/>
                </a>
            </li> : '' }
                ...
                <a href={'https://www.instagram.com/'+user.instagram} target="_blank" className="footer-redes-a">
                    <img className="footer-redes-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/footer/instagram.png" alt=""/>
                </a>
    ...
    <div className="contactar">
                ...
                <a href={'tel:'+user.phone} className="contactanos-a contactanos-a--phone"> 
                    <span className="contactanos-span">
                        <img className="contactanos-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/footer/telefono.png" alt=""/>
                    </span> {user.phone}
                </a>
...
{ user.other_phone   != null ? 
           ...
           : '' }
                <a href="skype:lolita.viajesoaxaca?call" target="_blank" className="contactanos-a contactanos-a--phone"> 
                    <span className="contactanos-span">
                        <img className="contactanos-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/footer/skype2.png" alt=""/>
                    </span> lolita.viajesoaxaca
                </a>
                <a href={'mailto:'+user.agency_mail} target="_blank" className="contactanos-a contactanos-a--email"> 
                    <span className="contactanos-span">
                        <img className="contactanos-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/footer/correo.png" alt=""/>
        ...
        { user.whatsapp   != null ? 
                <a href={'https://api.whatsapp.com/send?phone=52'+user.whatsapp+'&amp;text='+user.name_agency+''} target="_blank" className="redes-a">
                    <img className="redes-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/video-quienes-somos/whatsapp-black.png" alt=""/></a>
           : '' }

            
          {  user.messenger   != null ?
                <a href={'https://m.me/'+user.messenger+''} target="_blank" className="redes-a">
                    <img className="redes-img" src="https://exodus.b-cdn.net/exodus/geo/brasil/img/video-quienes-somos/messenger-black.png" alt=""/>
                </a>
         : ''  }
