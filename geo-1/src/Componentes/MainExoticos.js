    ...
    {/* <img src="http://mecamx.net/exodus2020/africa/img/slider-principal/slider-principal.jpg" alt="" className="section-main__image"/>*/}
        ...
        <div className="container">
            <div className="row">
                ...
                <iframe className="iframe-mega" title="caribe" src="https://www.megatravel.com.mx/tools/vi.php?Dest=10&txtColor=fff&aColor=fff&ahColor=fff&thBG=fff&thTxColor=fff&ff=3" width="100%" height="1200" border="0"align="left" allowtransparency="true" frameborder="0"> </iframe>
                </div> 
            </div> 
        </div>   
        </section>
