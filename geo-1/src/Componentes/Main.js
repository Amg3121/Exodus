...
function Main({user}) {
	...
	let slides3d = [
		<img  src="https://exodus.b-cdn.net/exodus/africa/img/video-quienes-somos/carrusel/img1.jpg" alt="1" />,
	    <img  src="https://exodus.b-cdn.net/exodus/africa/img/video-quienes-somos/carrusel/img2.jpg" alt="2" />  ,
	    <img  src="https://exodus.b-cdn.net/exodus/africa/img/video-quienes-somos/carrusel/img3.jpg" alt="3" />  
	];
	...
	<section className="section-main">
        <img src="https://exodus.b-cdn.net/exodus/geo/africa/img/slider-principal.eb130190.jpg" alt="" className="section-main__image"/>
    ...
    <section className="section-mega-offers">
        ...
        <h4 className="mega-offers-title">
            <img src="https://exodus.b-cdn.net/exodus/africa/img/mega-ofertas/mega-ofertas.png" alt="" className="mega-offers-title__image"/>
        </h4>
...
<a href={"detail/"+c2.mt+"/"+c2.name} className="carousel-best-sellers__item-link">
	<img src={c2.img+"?width=290"} alt="" className="carousel-best-sellers__item-image"/>
</a>
...
<a href={"detail/"+c5.mt+"/"+c5.name} className="carousel-scheduled-departures__item-link">
	<img src={c5.img+"?width=290"} alt="" className="carousel-scheduled-departures__item-image"/>
</a>
    ...
    <section className="section-favorites">
		...
		<Slider {...slides3}>
			...
			<a href={"detail/"+c3.mt+"/"+c3.name} className="carousel-favorites__item-link">
				<img src={c3.img+"?width=290"} alt="" className="carousel-favorites__item-image"/>
			</a>
        ...
        <div className="megatraveler">
            ...
            <div className="megatraveler__info">
                <h3 className="megatraveler__title">
                    <img src="https://exodus.b-cdn.net/exodus/africa/img/mega-traveler/mega-traveler.png" alt="" className="megatraveler__title--image"/>
                </h3>
                ...
                <div className="megatraveler__content-button">
                    ...
                    <a href={traveler.url} target="_blank" className="megatraveler__button">
                        <span className="megatraveler__button--span">
                            <img src="https://exodus.b-cdn.net/exodus/africa/img/mega-traveler/ver.png" alt="" className="megatraveler__icon--button" />
                        </span> ver
                    </a>

                    <a href={traveler.descarga} target="_blank" className="megatraveler__button">
                        <span className="megatraveler__button--span">
                            <img src="https://exodus.b-cdn.net/exodus/africa/img/mega-traveler/descargar.png" alt="" className="megatraveler__icon--button" />
                        </span> descargar
                    </a>
    ...
    <section className="video">
        ...
        <div className="content-video">
            <a href="" data-toggle="modal" data-target="#exampleModal" className="video-link">
                <img src="https://exodus.b-cdn.net/exodus/africa/img/video-quienes-somos/video.jpg" alt="" className="video-image" />
            </a>
        </div>
