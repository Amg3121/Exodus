			...
			<div class="container" id="about">
				<div class="row">
					...
					<div class="col-md-12 text-center mt-5 mb-5">
						<a href={'tel:'+user.phone} class="binoculars-contacto button-trendy-1">Contactanos ahora: {user.phone}</a>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="row">
							<div class="col-md-4">
								<img className="imgavion" src="https://exodus.b-cdn.net/exodus/trendy/01/img/1_sprites.png" alt=""/>
							</div>
							<div class="col-md-8">
...
{ user.instagram != null ? <li className="list-inline-item">
		...
		<section class="my-favoritos back-trendy-1">
			<div class="container">
