                        ...
                        <div className="container">
                            <ul className="list-inline text-center">
                                <li className="list-inline-item">
                                    <a href={traveler.url} target="_blank" className="btn__revista border-amarillo amarillo amarillohover"> <span><i className="fas fa-eye"></i></span>  Ver</a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={traveler.descarga} target="_blank" className="btn__revista border-amarillo amarillo amarillohover"><span><i className="fas fa-download"></i></span>  descargar</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="planificar back_planificar_amarillo text_planificar_amarillo">
                            ...
                            <div className="row">
                                <div className="col-md-12 text-right">
                                    <a href="#contacto" className="contactame back__amarillo">Contáctame</a>
                                </div>
                            </div>
                        </div>
                        </div>
