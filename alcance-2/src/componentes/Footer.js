				...
				<div className="row">
					<div className="col-md-6">
						...
						<form method="post" action="https://www.scriptsexodus.exodus.mx/send-template.php">
							...
							<button type="submit" className="btn-back-yellow btn-enviar mt-4">Enviar Ahora</button>
						  </form>
					</div>
				<div className="col-md-6">
						...
						{/* <p className="text-footer text-center">{user.city_name}, {user.state_name} <br/><a href={'tel:'+user.phone}>Tel.: {user.phone}</a><br/> <a href={'mailto:'+user.agency_mail}>{user.agency_mail}</a></p>*/ }
