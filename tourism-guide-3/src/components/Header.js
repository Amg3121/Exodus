            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item">
                        <a className="nav-link nav_link border-red somos" href="/#about">Quienes Somos</a>
                    </li>
                    <li className="nav-item dropdown position-static">
                        <a className="nav-link nav_link border-red dropdown-toggle destinos" data-toggle="dropdown" id="navbarDropdown" role="button">Destinos</a>
                        <ul className="dropdown-menu megamenu">
                            <div className="row">
                                <li className="col-md-3">
                                    <ul>
                                        <li>
                                            <a href="/europa" className="nav_link_sub nav-link-red">europa</a>
                                        </li>
                                        <li>
                    ...
                    <li className="nav-item">
                        <a className="nav-link nav_link border-red contacto" href="#contact">Contacto</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link nav_link border-red promociones" href="/ofertas">Ofertas y Promociones</a>
                    </li>
                    <li className="nav-item">
                    
                    <a  className="nav-link change btn-back-red" href="#"><i className="far fa-money-bill-alt"></i> MXN {tc}</a>
