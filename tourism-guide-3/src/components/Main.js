				...
				<div className="top-ten">
					...
					<div className="item item-slide-content" key={c2.mt}>
						...
						<a href={'/detail/'+c2.mt+'/'+c2.name}>
							...
							<p className="price-text back-red">${c2.price_from}</p>
						</div>
				...
				{carousel5.map(c5 => (
					<div className="item item-slide-content" key={c5.mt}>
						...
						<a href={'/detail/'+c5.mt+'/'+c5.name}>
							...
							<p className="price-text back-red">${c5.price_from}</p>
						</div>
						<div className="item-slide-info">
			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="col-md-5 pl-5">
						...
						<img src="https://exodus.b-cdn.net/exodus/tourism/03/img/06_MEGATV_001.png" className="img-fluid" alt=""/>
					</div>
				</div>
			</div>
		</section>
			...
			<div className="container">
				...
				{carousel3.map(c3 => (
					<div className="slick_item" key={c3.mt}>
						...
						<p className="title-favorites color-red">{c3.name}</p>
