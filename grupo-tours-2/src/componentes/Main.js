		...
		<section  className="aboutus" id="about">
			<div className="container">
					...
					<div className="wpb_single_image wpb_content_element vc_align_left">		
						<figure className="wpb_wrapper vc_figure">
							<div className="vc_single_image-wrapper   vc_box_border_grey">
                                <img className="vc_single_image-img " src="https://exodus.b-cdn.net/exodus/grupo-tours/01/img/chica.png" width="250" height="200" alt="Group 25" title="Group 25"/>
				...
				<p>CHAT EN LINEA</p>
					...
					<div className="wpb_text_column wpb_content_element  st-about--btn">
						<div className="wpb_wrapper">
