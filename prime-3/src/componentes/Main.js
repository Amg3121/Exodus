  ...
  return (
    <>
      <main>
          ...
          <div className="container-template">
            <div className="row">
              <div className="col-md-6">
                <img src="https://exodus.b-cdn.net/exodus/prime/03/img/globo.png" className="img-fluid" alt="agencia de viajes" />
              </div>
              <div className="col-md-6">
                ...
                <a href="#contacto" className="btn-section-one btn-back-pino">Quiero recibir asesoría</a>
              </div>
            </div>
          </div>
          <div className="divider background-pino-blue"></div>
        </section>
        <section className="confiarnos background-pino-blue">
            ...
            <div className="row items-confiarnos">
              <div className="col-md-12 d-flex flex-wrap justify-content-center">
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-4 pl-md-4 pr-md-5 py-2 link-confiranos">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/planeacion.png" alt="" />
                ...
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-4 pl-md-4 pr-md-5 py-2 link-confiranos">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/asesoria.png" alt="" />
                ...
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-4 pl-md-4 pr-md-5 py-2 link-confiranos">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/precios-competitivos.png" alt="" />
              ...
              <div className="col d-flex flex-wrap justify-content-center">
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-4 pl-md-4 pr-md-5 py-2 link-confiranos">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/optimizacion.png" alt="" />
        ...
        <section className="salidas-programadas background-pino-blue">
          <div className="container-template-slide">
              ...
              <div className="col-md-12 d-flex flex-wrap justify-content-center">
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-3 pl-md-3 pr-md-3 py-2 ">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/vuelos.png" alt="" />
                    </span>
                  </a>
                </div>
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-3 pl-md-3 pr-md-3 py-2 ">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/hospedaje.png" alt="" />
                    </span>
                  </a>
                </div>
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-3 pl-md-3 pr-md-3 py-2 ">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/alimentos.png" alt="" />
                    </span>
                  </a>
                </div>
                <div className="m-2 text-dark">
                  <a href="" className="media rounded align-items-center pl-3 pr-3 pl-md-3 pr-md-3 py-2 ">
                    <span className="span-confiarnos">
                      <img src="https://exodus.b-cdn.net/exodus/prime/03/img/transportacion.png" alt="" />
                    </span>
                  </a>
                </div>
              </div>
        ...
        <section className="mega-ofertas mega-ofertas-back background-verano-pino">
          <div className="container-template-slide">
          ...
          <div className="container-template">
            <div className="row">
              <div className="col-md-4">
                ...
                <a href="" data-toggle="modal" data-target="#exampleModal" className="btn-megatv btn-back-pino">
                  <span>
                    <img src="https://exodus.b-cdn.net/exodus/prime/03/img/mega-tv.png" alt="" />
                  </span>MEGA TV
                </a>
                <a href="" data-toggle="modal" data-target="#exampleModal2" className="btn-megatv btn-back-pino">
                  <span>
                    <img src="https://exodus.b-cdn.net/exodus/prime/03/img/mega-traveler.png" alt="" />
                  </span>MEGA traveler
                </a>
              </div>
              <div className="col-md-4">
                <img src="https://exodus.b-cdn.net/exodus/prime/03/img/smartphone.png" className="img-fluid" alt="" />
              </div>
              <div className="col-md-4">
                ...
                <div className="alert back-respuesta rounded-lg d-inline-block mb-4">
                  <div className="d-flex align-items-center">
                    <div className="badge badge-pill"><img src="https://exodus.b-cdn.net/exodus/prime/03/img/cliente-opinion.png" alt="" /></div>
                    ...
                    <div className="col-md-12">
                      <div className="row">
                        <div class="col-md-6">
                          ...
                          <a href={traveler.url} target="_blank" class="btn-megatv btn-back-pino">
                            <span><img src="https://exodus.b-cdn.net/exodus/prime/03/img/mega-tv.png" alt="" />
                            </span>VER</a>
                          <a href={traveler.descarga} target="_blank" class="btn-megatv btn-back-pino">
                            <span><img src="https://exodus.b-cdn.net/exodus/prime/03/img/mega-traveler.png" alt="" />
                            </span>DESCARGAR</a>
                        </div>
                        <div class="col-md-6">
              ...
              <div className="somos owl-carousel owl-theme">
                <div className="item item-slide-content">
                  <a href="">
                    <div className="row">
                      <div className="col-md-4">
                        <img src="https://exodus.b-cdn.net/exodus/prime/03/img/img-quienes-somos.png" alt="" className="mainimg1" />
                      </div>
