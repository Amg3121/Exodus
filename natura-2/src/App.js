  ...
  return (
    ...
    <section className="section-top-ten">
        <div className="container">
            <div className="row">
                <div className="col-md-12">
          <iframe className="iframe-detail" src={'https://www.megatravel.com.mx/tools/circuito.php?&txtColor=7f7f7f&aColor=7f7f7f&ahColor=91533a&thBG=91533a&thTxColor=fff&ff=2&viaje='+detail} width="100%" height="1200"  allowtransparency="true"> </iframe>
          </div> 
            </div> 
        </div>   
        </section>      
...
function App() {
  ...
  const [datos, setUser] = useState([]);
    ...
    useEffect(() => {
    axios.get('https://2020.exodus.mx/api/agency/470').then(res => {
