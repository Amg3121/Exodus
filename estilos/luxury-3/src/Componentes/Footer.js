...
<footer>
        <section className="seccionfooter back__footer_amarillo">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        { user.facebook  != null ? <li className="list-inline-item">
                                <a href={'https://www.facebook.com/'+user.facebook} className="link__networks-footer"><i className="fab fa-facebook-square"></i></a>
                            </li> : '' }
