    ...
    return (
            ...
            <div className="container quienes__somos">
                <div className="row">
                    <div className="col-md-4 text-center">
                        <img src="https://exodus.b-cdn.net/exodus/luxury/03/img/title01.png" alt=""/>
                    ...
                    <div className="col-md-4 text-center">
                        <img src="https://exodus.b-cdn.net/exodus/luxury/03/img/title02.png" alt=""/>
                        <h5 className="text-center somos__title">Redes Sociales</h5>
                        <ul className="list-inline text-center">

						{ user.facebook  != null ? <li className="list-inline-item">
                                <a href={'https://www.facebook.com/'+user.facebook} className="link__networks"><i className="fab fa-facebook-square"></i></a>
                            </li> : '' }
                ...
                { user.twitter != null ? <li className="list-inline-item">
                    ...
                    <div className="col-md-4 text-center">
                        <img src="https://exodus.b-cdn.net/exodus/luxury/03/img/title03.png" alt=""/>
                        <h5 className="text-center somos__title">Chat en linea</h5>
                        <ul className="list-inline text-center">
                            <li className="list-inline-item">
                                <a href="https://m.me/123170981072361" target="_blank" className="link__networks-msg"><i className="fab fa-facebook-messenger"></i></a>
                            </li>
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="container">
                            <ul className="list-inline text-center">
                                <li className="list-inline-item">
                                    <a href={traveler.url} targer="_blank" className="btn__revista border-amarillo amarillo amarillohover"> <span><i className="fas fa-eye"></i></span>  Ver</a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={traveler.descarga} targer="_blank" className="btn__revista border-amarillo amarillo amarillohover"><span><i className="fas fa-download"></i></span>  descargar</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="container__img-mapa">
                            <img src="https://exodus.b-cdn.net/exodus/luxury/03/img/mapa.png" alt="" className="img-fluid"/>
                        </div>
                        <div className="planificar back_planificar_amarillo text_planificar_amarillo">
                            <div className="line__planificar line_amarillo">
                            <h4 className="planificar__h4">{traveler.desc}</h4>
                             <div className="container">
                            <div className="row">
                                <div className="col-md-12 text-right">
                                    <a href="#contacto" className="contactame back__amarillo">contactame</a>
                                </div>
                            </div>
                        </div>
                        </div>
        ...
        <section className="seccionfavoritos">
			...
			<div className="info__favoritos">
				<div className="dias back__items__amarillo">
				{c3.days} dias / {c3.nights} noches
				</div>
				<div className="desde back__items__amarillo">
        ...
        <section className="experiencia">
            ...
            <p className="text-center experiencia__subtitle">Comunicate con nostros</p>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-8">
                        <form method="post" action="https://www.exodus.mx/includes/send-template.php" className="container__form">
                            <div className="form-group">
                              <input type="email" name="email" className="form-control input__form back__amarillo2" id="" placeholder="Email*" required/>
                              
                            </div>
                            <div className="form-group">
                                <input type="text" name="asunto" className="form-control input__form back__amarillo2" id="" placeholder="Asunto*" required/>
                                
                              </div>
                              <div className="form-group">
                                <input type="text" name="telefono" className="form-control input__form back__amarillo2" id="" placeholder="Telefono / Celular" required/>
                                
                              </div>
                            <div className="form-group">
                              
                              <input type="text" name="mensaje" className="form-control textarea__form back__amarillo2" placeholder="Mensaje"/>
                            </div>
                        ...
                        <input type="hidden" name="recaptcha_response" id="recaptchaResponse"/>
                            ...
                            <button type="submit" className="btn__form back__amarillo border-amarillo">Enviar</button>
                          </form>
                    </div>
                </div>
            </div>
        ...
        <section className="seccionvideos">
			...
			<a data-fancybox="true" href={tv.link}>	<img src={tv.img} alt=""/> </a>
			</div>
