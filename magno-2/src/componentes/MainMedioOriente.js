...
function MainMedioOriente({ user }) {
				...
				<div className="container">
					<div className="row">
						<div className="col-md-12">
							...
							<iframe className="iframe-mega" title="mediooriente" src="https://www.megatravel.com.mx/tools/vi.php?Dest=2&txtColor=13547e&aColor=13547e&ahColor=28cec4&thBG=28cec4&thTxColor=13547e&ff=1" width="100%" height="1200" border="0" align="left" allowtransparency="true" frameborder="0"> </iframe>
						</div>
					</div>
				</div>
			</section>
