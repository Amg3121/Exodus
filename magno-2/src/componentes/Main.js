    ...
    return (
            ...
            <div className="container-template">
                <div className="row">
                    <div className="col-lg-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        ...
                        <div className="line green-dark"></div>
                        <div className="row">
                    ...
                    <div className="col-lg-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <img src="https://exodus.b-cdn.net/exodus/magno/02/img/1_iMac.png" className="img-fluid" alt="" />
                    </div>
                </div>
            </div>
        </section>

        <section className="banners back-green">
            <div className="way-point way-point-green">
            ...
            <div className="container-template">
                <div className="container-title">
                    <span className="back-title-black back-text-title-green">mega ofertas</span>
                    <h3 className="title-white">mega ofertas</h3>
                </div>
                <div className="line green-color"></div>
                ...
                <Slider {...slides2}>
					{carousel2.map(c2 => (
							...
							<a href={'detail/'+c2.mt+'/'+c2.name} className="main__sections-item-link">
                                ...
                                <div className="info green-transparent">
                ...
                <div className="container-title">
                    <span className="back-title-black back-text-title-green">temporada</span>
                ...
                <div className="container-title">
                    <span className="back-title-black back-text-title-green">bloqueos</span>
            ...
            <div className="info green-transparent">
                ...
                <div className="container-title">
                    <span className="back-title-black back-text-title-green">favoritos</span>
      ...
      <img className="slide_desktop img-fluid" src={c1.img1} alt=""/>
            ...
            <div className="info-slide">
                        ...
                        {/*<a href={"detail/"+c1.mt+"/"+c1.name} className="button-template button-green">mas informacion</a>*/}
                        </div>
               ...
               <div className="container-template">
                   <div className="row traveler">
                       <div className="col-md-6">
                        ...
                        <div className="line-dark green-dark"></div>
                       ...
                       <img src={traveler.img} alt={traveler.title} className="img-fluid"/>
                           ...
                           <a href={traveler.url} target="_blank" className="button-template button-green"> <span><i className="far fa-eye" aria-hidden="true"></i></span> Ver</a>
                           <a href={traveler.descarga} target="_blank"  className="button-template button-green"><span><i className="fas fa-download" aria-hidden="true"></i></span> Descargar</a> 
                           </div>
                       </div>
                   ...
                   <div className="row megatv">
                    <div className="col-md-6">
                     ...
                     <div className="col-md-6 text-center">
                         ...
                         <a href="#" data-toggle="modal" data-target="#exampleModal" className="button-template button-green">ver</a>
                         </div>
                     </div>
                  </div>
               </div> 
