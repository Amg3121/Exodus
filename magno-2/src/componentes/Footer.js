        ...
        <div className="container-template">
            <div className="row">
                <div className="col-md-6">
                    <h3 className="title-footer color-green">información de contacto</h3>
                    <p className="paragraph-footer">
                        <span className="span-market"><i className="fas fa-map-marker-alt color-green"></i></span>
                ...
                <div className="col-md-6">
                   <p className="paragraph-envelope"> <span className="span-envelope"><i className="fas fa-envelope-open color-green"></i></span> <a href={'mailto:'+user.agency_mail} target='_blank'> {user.agency_mail} </a> </p>
                   <p className="paragraph-mobile"> <span className="span-mobile"><i className="fas fa-mobile-alt color-green"></i></span>  <a href={'tel:'+user.phone} target='_blank'> {user.phone} </a>   </p>
                   ...
                   <form method="post" action="https://www.scriptsexodus.exodus.mx/send-template.php" className="form-footer">
                    <div className="form-group form-group-footer row">
                        ...
                        <div className="col-sm-10">
                          <input type="text" className="form-control input-footer green-input" placeholder="Nombre*" required/>
                        </div>
                      </div>
                      <div className="form-group form-group-footer row">
                        <label for="" className="col-sm-2 col-form-label label-footer">Asunto</label>
                        <div className="col-sm-10">
                          <input type="text" name="asunto" className="form-control input-footer green-input"  placeholder="Asunto*" required/>
                        </div>
                      </div>
                      <div className="form-group form-group-footer row">
                        <label for="" className="col-sm-2 col-form-label label-footer">E-mail</label>
                        <div className="col-sm-10">
                          <input type="email" name="email" className="form-control input-footer green-input"  placeholder="Email*" required/>
                        </div>
                      </div>
                      <div className="form-group form-group-footer row">
                        <label for="" className="col-sm-2 col-form-label label-footer">Tel:</label>
                        <div className="col-sm-10">
                          <input type="text" name="telefono" className="form-control input-footer green-input"  placeholder="telefono*" required/>
                        </div>
                      </div>
                      ...
                      <input type="hidden" name="agencia" value={user.agency_mail} />
							...
							<button type="submit" className="button-template button-green">Enviar Ahora</button>
