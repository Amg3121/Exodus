  ...
  return (
    ...
    <section className="section-top-ten">
        <div className="container">
          ...
          <iframe className="iframe-detail" title="detail" src={'https://www.megatravel.com.mx/tools/circuito.php?&txtColor=000000&aColor=000000&ahColor=85dbdc&thBG=4f0367&thTxColor=fff&ff=2&viaje='+detail} width="100%" height="1200"  allowtransparency="true"> </iframe>
          </div> 
            </div> 
        </div>   
        </section> 
...
function App() {
  ...
  useEffect(() => {
  axios.get('https://2020.exodus.mx/api/agency/475').then(res => {
