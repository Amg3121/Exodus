				...
				<div className="row">
					...
					<div className="col-md-4">
						...
						<ul>
							...
							return  <a key={index} href={dato.facebook} className="under-red networks-link"><i className="fab fa-facebook networks-icon"></i>{dato.facebook}</a>;
							})}
							...
							return  <a key={index} href={dato.instagram} className="under-red networks-link"><i className="fab fa-instagram networks-icon"></i>{dato.facebook}</a>;
							})}
							...
							return  <a key={index} href={dato.twitter} className="under-red networks-link"><i className="fab fa-twitter-square networks-icon"></i>{dato.twitter}</a>;
							})}
					...
					<div className="col-md-4">
						...
						<ul>
							...
							return  <a href="/" key={index} className="under-red networks-link"><i className="fab fa-whatsapp-square networks-icon"></i>{dato.whatsapp}</a>;
							})}
