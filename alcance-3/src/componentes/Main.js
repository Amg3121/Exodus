...
function Main({ user }) {
	...
	return (
		<>
			...
			<section className="back-about back-about-red" id="about">
				<div className="container-template">
					<div className="row">
						...
						<div className="col-md-12 text-center">
							<a href="#about" className="btn-about btn-back-red mt-4">Empezar</a>
						</div>
					</div>
				</div>
			</section>
						...
						<div className="col-lg-4 col-md-4 col-sm-4 col-12 seasons-item">
							...
							<div className="seasons-info">
								<div className="seasons-content">
									...
									<a className="seasons-link btn-seasons-red" data-toggle="modal" data-target="#exampleModal2">ver ahora</a>
								</div>
							</div>
						</div>
						<div className="col-lg-4 col-md-4 col-sm-4 col-12 seasons-item">
							...
							<div className="seasons-info">
								<div className="seasons-content">
									...
									<a href="#" className="seasons-link btn-seasons-red" data-toggle="modal" data-target="#exampleModal3">ver ahora</a>
								</div>
							</div>
						</div>
						<div className="col-lg-4 col-md-4 col-sm-4 col-12 seasons-item">
							...
							<div className="seasons-info">
								<div className="seasons-content">
									...
									<a href="#" className="seasons-link btn-seasons-red" data-toggle="modal" data-target="#exampleModal4">ver ahora</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div className="col-md-5">
							...
							<div className="row">
								...
								<div className="col-md-6 text-center">
									<a href={traveler.url} target="_blank" className="btn-back-red descargar">VER AHORA</a>
								</div>
								<div className="col-md-6 text-center">
									<a href={traveler.descarga} target="_blank" className="btn-back-red descargar">DESCARGAR</a>
								</div>
							</div>
						</div>
					</div>
					<div className="row">
						<div className="col-md-7">
							<div className="row  mt-megatraveler">
								...
								<div className="col-md-12 text-center">
									<a href="" className="btn-back-red descargar" data-toggle="modal" data-target="#exampleModal">VER AHORA</a>
								</div>
							</div>
						</div>
						...
						<div className="col-lg-6 col-md-12 col-sm-12 seasons-item">
							...
							<div className="seasons-info">
								<div className="seasons-content">
									...
									<a href="#" className="seasons-link btn-seasons-red" data-toggle="modal" data-target="#exampleModal2">ver ahora</a>
								</div>
							</div>
						</div>
								...
								<div className="col-md-6 seasons-item">
									...
									<div className="seasons-info">
										<div className="seasons-content">
											...
											<a href="#" className="seasons-link btn-seasons-red" data-toggle="modal" data-target="#exampleModal5">ver ahora</a>
										</div>
									</div>
								</div>
							</div>
				...
				<div className="container">
					<div className="row">
						<div className="col-md-4">
							...
							<h4 className="networks-title color-red">llamanos</h4>
						...
						<div className="col-md-4">
							...
							<h4 className="networks-title color-red">redes sociales</h4>
							<p className="text-networks">Siguenos en nuestras redes sociales. ¡Dale Me Gusta!</p>
							<ul>
								<li>
									{user.facebook == null ? '' : <a href={'https://www.facebook.com/' + user.facebook} target="_blank" className="under-red networks-link"><i className="fab fa-facebook networks-icon"></i>{user.facebook}</a>}
								</li>
								<li>
									{user.instagram == null ? '' : <a href={'http://instagram.com/' + user.instagram} target="_blank" className="under-red networks-link"><i className="fab fa-instagram networks-icon"></i>{user.instagram}</a>}
								</li>
								<li>
									{user.twitter == null ? '' : <a href={'https://twitter.com/' + user.twitter} target="_blank" className="under-red networks-link"><i className="fab fa-twitter networks-icon"></i>{user.twitter}</a>}
								</li>
							</ul>
						</div>
						<div className="col-md-4">
							<img className="img-fluid" src="https://exodus.b-cdn.net/exodus/alcance/chat.webp" alt="" />
							<h4 className="networks-title color-red">chatea con nosotros</h4>
							<p className="text-networks">Estamos en línea, escríbenos para ayudarte a planear tu próximo viaje. </p>
							<ul>
								<li>
									{user.whatsapp == null ? '' : <a href={'https://api.whatsapp.com/send?phone=52' + user.whatsapp} className="under-red networks-link" target="_blank"><i className="fab fa-whatsapp-square networks-icon"></i>{user.whatsapp}</a>}
								</li>
							</ul>
						</div>
					</div>
