            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item">
                        <a className="nav-link nav_link under-red home" href="/">Home</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link nav_link under-red somos" href="/#about">Quienes Somos</a>
                    </li>
                    <li className="nav-item dropdown position-static">
                        <a className="nav-link nav_link under-red dropdown-toggle destinos" data-toggle="dropdown" href="/" id="navbarDropdown" role="button">Destinos</a>
                    ...
                    <li className="nav-item">
                        <a className="nav-link nav_link under-red contacto" href="#contact">Contacto</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link nav_link under-red promociones" href="/ofertas">Ofertas y Promociones</a>
                    </li>
                    <li className="nav-item">
                     {tc == '' ? '' : <a className="nav-link nav_link under-red promociones"><i className="far fa-money-bill-alt"></i> MXN {tc}</a> }   
                    </li>
                </ul>
            </div>
        </div>
