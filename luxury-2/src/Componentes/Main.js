    ...
    return (
            ...
            <div className="container quienes__somos">
                <div className="row">
                    <div className="col-md-4 text-center">
                        <img src="https://exodus.b-cdn.net/exodus/luxury/02/img/title01.png" alt=""/>
                    ...
                    <div className="col-md-4 text-center">
                        <img src="https://exodus.b-cdn.net/exodus/luxury/02/img/title02.png" alt=""/>
                        <h5 className="text-center somos__title">Redes Sociales</h5>
                        <ul className="list-inline text-center">

						{ user.facebook  != null ? <li className="list-inline-item">
                                <a href={'https://www.facebook.com/'+user.facebook} target="_blank" className="link__networks"><i className="fab fa-facebook"></i></a>
                            </li> : '' }
                ...
                { user.twitter != null ? <li className="list-inline-item">
                    ...
                    <div className="col-md-4 text-center">
                        <img src="https://exodus.b-cdn.net/exodus/luxury/02/img/title03.png" alt=""/>
                ...
                <div className="row">
                        ...
                        <div className="container">
                            <ul className="list-inline text-center">
                                <li className="list-inline-item">
                                    <a href={traveler.url} target="_blank" className="btn__revista border-verde verde verdehover"> <span><i className="fas fa-eye"></i></span>  Ver</a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={traveler.descarga} target="_blank" className="btn__revista border-verde verde verdehover"><span><i className="fas fa-download"></i></span>  descargar</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="container__img-mapa">
                            <img src="https://exodus.b-cdn.net/exodus/luxury/02/img/mapa.png" alt="" className="img-fluid"/>
                        </div>
                        <div className="planificar back_planificar_verde text_planificar_verde">
                            <div className="line__planificar line_verde">
                            <h4 className="planificar__h4">{traveler.desc}</h4>
                             <div className="container">
                            <div className="row">
                                <div className="col-md-12 text-right">
                                    <a href="#contacto" className="contactame back__verde">Contáctame</a>
                                </div>
                            </div>
                        </div>
                        </div>
        ...
        <section className="seccionfavoritos">
			...
			<div className="info__favoritos">
				<div className="dias back__verde">
				{c3.days} dias / {c3.nights} noches
				</div>
				<div className="desde back__verde">
                    ...
                    <div className="col-md-8">
                        <form method="post" action="https://www.scriptsexodus.exodus.mx/send-template.php" className="container__form">
                            <div className="form-group">
                              <input type="email" name="email" className="form-control input__form back__verde2" id="" placeholder="Email*" required/>
                              
                            </div>
                            <div className="form-group">
                                <input type="text" name="asunto" className="form-control input__form back__verde2" id="" placeholder="Asunto*" required/>
                                
                              </div>
                              <div className="form-group">
                                <input type="text" name="telefono" className="form-control input__form back__verde2" id="" placeholder="Telefono / Celular" required/>
                                
                              </div>
                            <div className="form-group">
                              
                              <input type="text" name="mensaje" className="form-control textarea__form back__verde2" placeholder="Mensaje"/>
                            </div>
                        ...
                        <input type="hidden" name="recaptcha_response" id="recaptchaResponse"/>
                            ...
                            <button type="submit" className="btn__form back__verde border-verde">Enviar</button>
                          </form>
                    </div>
                </div>
            </div>
