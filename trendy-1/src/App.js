...
function Detail() {
  ...
  return (
      ...
      <section className="my-favoritos back-trendy-1">
            <h1 className="text-center title-my-favoritos">{name}</h1>
    ...
    <section className="section-top-ten">
        <div className="container">
          ...
          <iframe className="iframe-detail" title="detail" src={'https://www.megatravel.com.mx/tools/circuito.php?&txtColor=222436&aColor=222436&ahColor=ffe500&thBG=222436&thTxColor=fff&ff=2&viaje='+detail} width="100%" height="1200"  allowtransparency="true"> </iframe>
          </div> 
            </div> 
        </div>   
        </section> 
...
function App() {
  ...
  useEffect(() => {
  axios.get('https://2020.exodus.mx/api/agency/599').then(res => {
