...
function MainEventos() {
  ...
  <div className="main">
    ...
    <h1 className="main__span back__frutos">
                    lo mejor de Eventos Especiales
            </h1>
    </section>   
        ...
        <div className="container">
            <div className="row">
                ...
                <iframe className="iframe-mega" title="eventos"  src="https://www.megatravel.com.mx/tools/vi.php?Dest=12&txtColor=343a40&aColor=343a40&ahColor=e60a33&thBG=e60a33&thTxColor=fff&ff=7" width="100%" height="1200" border="0"align="left" allowtransparency="true" frameborder="0"> </iframe>
                </div> 
            </div> 
        </div>   
        </section>    
