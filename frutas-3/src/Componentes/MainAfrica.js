      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <iframe className="iframe-mega" title="africa" src="https://www.megatravel.com.mx/tools/vi.php?Dest=5&txtColor=343a40&aColor=343a40&ahColor=e60a33&thBG=e60a33&thTxColor=fff&ff=7" width="100%" height="1200" border="0"align="left" allowtransparency="true" frameborder="0"> </iframe>
          </div> 
        </div> 
      </div>   
    </section> 
