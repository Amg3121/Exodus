    ...
    <h1 className="main__span ">
        ...
        <div className="container">
            <div className="row">
                ...
                <iframe className="iframe-mega" title="Mexico" src="http://www.megatravel.com.mx/tools/vi.php?Dest=11&txtColor=212529&aColor=212529&ahColor=80b92e&thBG=80b92e&thTxColor=fff&ff=7" width="100%" height="4700" border="0"align="left" allowtransparency="true" frameborder="0"> </iframe>
                </div> 
            </div> 
        </div>   
        </section> 
