  ...
  return (
    ...
    <section className="section-top-ten">
        <div className="container">
          ...
          <iframe className="iframe-detail" title="detail" src={'https://www.megatravel.com.mx/tools/circuito.php?&txtColor=451316&aColor=451316&ahColor=c93840&thBG=c93840&thTxColor=fff&ff=7&viaje='+detail} width="100%" height="1200"  allowtransparency="true"> </iframe>
          </div> 
            </div> 
        </div>   
        </section> 
...
function App() {
  ...
  useEffect(() => {
  axios.get('https://2020.exodus.mx/api/agency/291').then(res => {
