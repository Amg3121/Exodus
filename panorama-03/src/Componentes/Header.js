  ...
  return (
    ...
    <header>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light nav__template padding__rem">
            <a class="navbar-brand menu__brand red_logo" href="/">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-multicol" aria-labelledby="navbarDropdown">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                    <a class="dropdown-item link__sub" href="/europa">viajes a europa</a>
                ...
                <div class="col-md-6">
                    ...
                    <a class="dropdown-item link__sub" href="/juvi">#juvi</a>
                    <a class="dropdown-item link__sub" href="/cruceros">cruceros</a>
                    <a class="dropdown-item link__sub" href="/exoticos">exoticos</a>
