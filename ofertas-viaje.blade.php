...
})(window,document,'script','dataLayer','GTM-NPTD5XR');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NPTD5XR"
...
<div data-price='{{$blq['price_from']}}' data-duration='{{$blq['days']}}' class='Item'>
  ...
  <strong>Desde ${{ number_format($blq['price_from']) }} <small>{{$blq['currency']}}</small> + ${{$blq['taxes']}} <small>IMP</small></strong><br/>
