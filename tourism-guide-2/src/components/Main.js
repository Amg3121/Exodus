    ...
    return (
			...
			<div className="container-template">
				<div className="row">
					...
					<div className="col-md-12 text-center">
						<a href="" className="btn-about btn-back-blue mt-4">Empezar</a>
					</div>
				</div>
			</div>
		</section>
				...
				<div className="top-ten">
					...
					<div className="item item-slide-content" key={c2.mt}>
						...
						<a href={'/detail/'+c2.mt+'/'+c2.name}>
							...
							<p className="price-text back-blue">${c2.price_from}</p>
						</div>
		...
		<section className="slide-full">
			...
			<div className="slide owl-carousel owl-theme">
			  ...
			  <img className="slide_movil img-fluid" src={c1.img2} alt="" width="100%"/>
					</a>
				...
				{carousel5.map(c5 => (
					<div className="item item-slide-content" key={c5.mt}>
						...
						<a href={'/detail/'+c5.mt+'/'+c5.name}>
							...
							<p className="price-text back-blue">${c5.price_from}</p>
						</div>
						<div className="item-slide-info">
			...
			<div className="container">
				...
				{carousel3.map(c3 => (
					<div className="slick_item" key={c3.mt}>
						...
						<p className="title-favorites color-blue">{c3.name}</p>
