		...
		<>
			<main>
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 container-main-title text-center">
								...
								<a href="#contacto" className="btn-agency btn-pink mt-4">¡Contáctanos YA!</a>
							</div>
						</div>
					</div>
				</section>
				<section className="my-about" id="about">
					<div className="container">
						<h2 className="title-section color-pink mb-4">Quienes Somos</h2>
						<div className="row">
					...
					<div className="container">
						<div className="row">
							<div className="col-md-3">
								<h2 className="title-section color-pink mb-4">{title2}</h2>
										...
										{carousel2.map(c2 => (
											<div className="item item-slide-content" key={c2.mt}>
												<div className="price-slide">
													...
													<p className="price-text back-pink-blue">${c2.price_from}</p>
												</div>
											</div>
										))}
									</Slider>
						...
						<div className="row back-promo mt-5">
							...
							<div className="col-md-4 text-right">
								<a href={'tel:' + user.phone} className="btn-back-pink-blue leer-mas mt-3">¡Llamanos!</a>
							</div>
						</div>
					</div>
				</section>
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12">
								<h3 className="title-section color-pink mb-4">{title4}</h3>
							</div>
						</div>
										...
										<div className="item-slide-info">
											...
											<div className="item-slide-price">
												<div className="row no-gutters">
													...
													<div className="col-md-6">
														<p className="text-right color-pink text-ofertas-price">${c4.price_from}</p>
													</div>
												</div>
											</div>
										</div>
				...
				<section className="section-locks">
					<div className="container">
						<div className="row">
							<div className="col-md-12">
								<h3 className="title-section color-pink mb-4">{title5}</h3>
							</div>
						</div>
				...
				<section className="my-favoritos">
					<div className="container">
						<div className="row">
							<div className="col-md-12">
								<h2 className="title-section color-pink mb-4">{title3}</h2>
							</div>
						</div>
							...
							<Slider {...slides3}>
								{carousel3.map(c3 => (
									<div className="item item-slide-content" key={c3.mt}>
										...
										<div className="item-slide-info">
											<small className="item-slide-days color-pink">{c3.name}</small>
											<div className="item-slide-price">
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-md-5">
								<div className="row">
									<div className="col-md-12">
										<h3 className="title-section text-right color-pink">{traveler.title}</h3>
										<h4 className="subtitle-section text-right mb-5 color-pink">{traveler.date}</h4>
									</div>
								</div>
								<div className="row back-white">
									...
									<div className="col-md-6 text-center">
										<a href={traveler.url} target="_blank" className="btn-back-pink-blue descargar">VER AHORA</a>
									</div>
									<div className="col-md-6 text-center">
										<a href={traveler.descarga} target="_blank" className="btn-back-pink-blue descargar">DESCARGAR</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="col-md-7">
								<div className="row back-megatraveler mt-megatraveler">
									...
									<div className="col-md-12 text-center">
										<a className="btn-back-pink-blue descargar" data-toggle="modal" data-target="#exampleModal">VER AHORA</a>
									</div>
								</div>
							</div>
							<div className="col-md-5 pl-5">
								<h3 className="title-section color-pink mt-4">MEGA TRAVELER</h3>
								<h4 className="subtitle-section mb-5 color-pink">Videos que inpiran a viajar</h4>
