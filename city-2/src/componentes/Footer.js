			...
			<div className="container">
				<div className="row">
					...
					<div className="col-md-5">
						<h3 className="title-section color-pink mb-4">Contacto</h3>
						...
						<div className="form-group">
							...
							<button type="submit" className="btn-back-pink-blue btn-enviar mt-4">Enviar Ahora</button>
						  </form>
					</div>
					<div className="col-md-2"></div>
					<div className="col-md-5">
						<img src="https://exodus.b-cdn.net/exodus/city/02/img/contacto.jpg" alt="" className="img-fluid-oferta" />
						
						<div className="info-content info-content-pink">
