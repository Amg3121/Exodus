...
function Footer({user}) {
    ...
    return (
        <>
    <footer>
        <section className="contacto back__sandia" id="contacto">
            <h3 className="contacto__title">contáctanos <div className="contacto__contaner-img contacto__contaner-sandia"><img src="https://exodus.b-cdn.net/exodus/frutas/sandia/img/sandia3.png" alt=""/></div> </h3>
            ...
            <div className="contacto__form">
                <form method="post" action="https://www.scriptsexodus.exodus.mx/send-template.php" className="formulario">
                    ...
                    <button type="submit" className="btn__formulario color__sandia hover__sandia">Enviar</button>
                </form>
            </div>
        </section>
