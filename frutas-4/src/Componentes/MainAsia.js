    ...
    <section className="section-top-ten">
        <div className="container">
            <div className="row">
                ...
                <iframe className="iframe-mega" title="asia"  src="https://www.megatravel.com.mx/tools/vi.php?Dest=4&txtColor=343a40&aColor=343a40&ahColor=fa0b54&thBG=fa0b54&thTxColor=fff&ff=7" width="100%" height="1200" border="0"align="left" allowtransparency="true" frameborder="0"> </iframe>
                </div> 
            </div> 
        </div>   
        </section>  
