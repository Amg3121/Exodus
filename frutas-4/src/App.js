            ...
            <ul className={ open2 ? "feat-show show" : "feat-show"}>
              ...
              <li>
                <a href="/centroamerica">
                  ...
                  <span className="span__submenu">centroamérica</span>
                </a>
              </li>
              <li>
                <a href="/pacifico">
...
<i class="fa fa-bars" aria-hidden="true"></i>
    ...
    <h1 className="main__span back__sandia">
                   {name}
    ...
    <section className="section-top-ten">
        <div className="container">
          ...
          <iframe className="iframe-detail" title="detail" src={'https://www.megatravel.com.mx/tools/circuito.php?&txtColor=343a40&aColor=343a40&ahColor=fa0b54&thBG=fa0b54&thTxColor=fff&ff=7&viaje='+detail} width="100%" height="1200"  allowtransparency="true"> </iframe>
          </div> 
            </div> 
        </div>   
        </section> 
...
function App() {
  ...
  useEffect(() => {
  axios.get('https://2020.exodus.mx/api/agency/591').then(res => {
