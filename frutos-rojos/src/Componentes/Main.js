...
function Main({user}) {
	...
	<div className="main">
		...
		<section className="main__header frutos">
			...
			<h1 className="main__h1">
                la mejor agencia <span className="main__span back__frutos">de viajes</span>
                <div className="maple">
					<img class="maple-img" src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/maple.png" alt=""/>
				</div>
            </h1>

            <div className="woman">
                <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/chica-frutos-rojos.png" alt="" className="woman__img" />
            </div>
        </section>
        ...
        <section className="main__carousel-hot back__frutos">
            <h3 className="title__sections">
				<span className="title__sections-icon">
                <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/play-white.png" alt="" className="title__sections-img"/>
                </span> 
                <p className="content__title">
                    lo mas <span className="title__sections-hot">hot</span>
                </p>
				<div className="aguacate">
                    <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/frutos1.png" alt="" className="responsive__aguacate"/>
                </div>
			</h3>
			...
			<div class="aguacate__sub">
				<img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/lentes.png" alt="" class="responsive__aguacate-sub"/>
			</div>
		</section>
		
		<section className="travels__carousel__section back__frutos__favoritos">
            <h3 className="travels__title__sections color__black">
				<span className="title__sections-icon">
                <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/play.png" alt="" className="title__sections-img"/>
                </span> 
                <p className="content__title">
        ...
        <section className="verano__carousel__section">
            <div className="verano__image">
                <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/chica-tabla.png" className="verano__image-img" alt=""/>
            </div>
            ...
            <div className="aguacate">
                <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/planta1.png" alt=""/>
            </div>
            <div className="main__sections owl-carousel owl-theme">
				<Slider {...slides4}>
					{carousel4.map(c4 => (
            ...
            <div className="plant__sub">
                <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/hojas.png" alt=""/>
            </div>
        </section>

        <section className="main__carousel__suenos back__frutos">
		...
		<section  className="container__section-hidden">
			<div className="section__see" id="somosagencia"><br/>
				<div className="aside__about-balloon" href="#somos">
					<img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/quienes-somos.png" alt="" className="responsive__img"/>
				</div>
				...
				<a href="#contacto" className="aside__about-a back__frutos hover__frutos">contacto</a>
				<hr />
				<div className="aside__networks-balloon">
					<img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/comunicate.png" alt="" className="responsive__img"/>
				</div>
				<div className="aside__networks-communicate">
					<img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/comunicate2.png" alt="" className="responsive__img"/>
				</div>
		...
		<section className="container__section-hidden">
            <div className="section__see">
				<div className="aside__map-balloon">
                    <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/visitanos.png" alt="" className="responsive__img"/>
                </div>
                <div className="aside__map-icon">
                    <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/ubicacion.png" alt="" className="responsive__img ubicacion-img"/>
                </div>
            ...
            <div className="aside__tv section__see"><hr />
                <div className="aside__tv-icon">
                    <img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/megatv-1.png" alt="" className="responsive__img" />
                </div>
			...
			<div className="aside__tv-phone section__see">
                <video className="" muted="muted" loop="loop" width="100%"  height="310">
                    <source src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/video/video-mega-tv.mp4" type="video/mp4" />
                </video>
            </div>
        </section>
		...
		<section className="megatraveler">
            <div className="container__megatraveler">
                ...
                <div className="container__megatraveler-btn">
                    <a href={traveler.descarga} target="_blank" className="btn-megatraveler back__frutos hover__frutos margin__btn-right">Descargar</a>
                </div>
				<div className="container__megatraveler-btn">
					<a href={traveler.url} target="_blank" className="btn-megatraveler back__frutos hover__frutos ">Ver Online</a>
        		</div>
			</div>
	...
	<section className="video">
    	<h3 className="video__title">#quieroviajar</h3>
        	<div className="container__video">
				...
				<img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/video.png" alt="" className="video-image" />
				</a>
			</div>  
			<div className="container__chicos">
				<img src="https://exodus.b-cdn.net/exodus/frutas/frutos-rojos/img/pareja.png" alt="" className="responsive__chicos" />
			</div>
