    ...
    return (
		...
		<div class="header__container--back">
          ...
          {/** <p class="text__title"> en {user.state_name}</p>*/} 
           ...
           <a href="#contacto" class="link__title "> Contacto </a>
            </div>
        </div>
...
{/*
    <section class="megatraveler __strong">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="megatraveler__container--buttons">
                    <a href={traveler.url} target="_blank" class="megatraveler__button ">ver</a>
                    <a href={traveler.descarga} target="_blank" class="megatraveler__button ">descargar</a>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mega__tv__container--buttons">
                        <a data-toggle="modal" data-target="#exampleModal" target="_blank" class="mega__tv__button __strong __button2">ver</a>
                    </div>
                </div>
                <div class="col-md-6">
