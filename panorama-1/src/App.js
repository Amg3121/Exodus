  ...
  return (
    ...
    <section className="section-top-ten">
        <div className="container">
          ...
          <iframe className="iframe-detail" title="detail" src={'https://www.megatravel.com.mx/tools/circuito.php?&txtColor=343a40&aColor=e0a331&ahColor=343a40&thBG=e0a331&thTxColor=fff&ff=7&viaje='+detail} width="100%" height="1200"  allowtransparency="true"> </iframe>
          </div> 
            </div> 
        </div>   
        </section> 
...
function App() {
  ...
  useEffect(() => {
  axios.get('https://2020.exodus.mx/api/agency/663').then(res => {
