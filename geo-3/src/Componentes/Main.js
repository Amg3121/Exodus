...
function Main({ user }) {
	...
	// -- Fin Mega en Vivo -- //
	let slides3d = [
		<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/video-quienes-somos/carrusel/img1.jpg" alt="1" />,
		<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/video-quienes-somos/carrusel/img2.jpg" alt="2" />,
		<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/video-quienes-somos/carrusel/img3.jpg" alt="3" />
	];
	return (
		<>
			<section className="section-main">
				<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/slider-principal.242ec56a.jpg" alt="" className="section-main__image" />
			...
			<section className="section-mega-offers">
				<h4 className="mega-offers-title">
					<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/mega-ofertas.69aa2c0b.png" alt="" className="mega-offers-title__image" />
				</h4>
				...
				<div className="megatraveler">
					<div className="megatraveler__info">
						<h3 className="megatraveler__title">
							<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/mega-traveler.44fd220e.png" alt="" className="megatraveler__title--image" />
						</h3>
						...
						<div className="megatraveler__content-button">
							<a href={traveler.url} target="_blank" className="megatraveler__button">
								<span className="megatraveler__button--span">
									<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/mega-traveler/ver.png" alt="" className="megatraveler__icon--button" />
								</span> ver
							</a>
							<a href={traveler.descarga} target="_blank" className="megatraveler__button">
								<span className="megatraveler__button--span">
									<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/mega-traveler/descargar.png" alt="" className="megatraveler__icon--button" />
								</span> descargar
							</a>
						</div>
					</div>
			...
			<section className="video">
				...
				<div className="content-video">
					<a href="" data-toggle="modal" data-target="#exampleModal" className="video-link">
						<img src="https://exodus.b-cdn.net/exodus/geo/japon/img/video-quienes-somos/video.jpg" alt="" className="video-image" />
					</a>
				</div>
			</section>
