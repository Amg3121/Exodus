  ...
  return (
    ...
    <header>
                        ...
                        <li class="exchange-rate__list-item">
                            <a href="" class="exchange-rate__link">
                                <span class="exchange-rate__span exchange-rate__span--home">
                                     <img src="https://exodus.b-cdn.net/exodus/geo/japon/img/header/home.png" alt="" class="exchange-rate__image"/>
                                </span>     
                            </a>
                        </li>
                        <li class="exchange-rate__list-item">
                ...
                <li class="menu__nav-item nav-item--pink">
                    <a href="/promociones" class="menu__nav-link">
                        <span class="menu__span"> 
                            <img src="https://exodus.b-cdn.net/exodus/geo/japon/img/menu/ofertas-promociones.png" alt="" class="menu__image"/>
      ...
      onClick={ () => setOpen(!open) }>
                        <span class="menu__span"> 
                            <img src="https://exodus.b-cdn.net/exodus/geo/japon/img/menu/destinos-viaje.png" alt="" class="menu__image"/>
                        </span> destinos de viaje </a>
                </li>
                <li class="menu__nav-item nav-item--yellow">
                    <a href="/#somos" class="menu__nav-link">
                        <span class="menu__span"> 
                            <img src="https://exodus.b-cdn.net/exodus/geo/japon/img/menu/quienes-somos.png" alt="" class="menu__image"/>
                        </span> quienes somos</a>
                </li>
                <li class="menu__nav-item nav-item--green">
                    <a href="#contacto" class="menu__nav-link">
                        <span class="menu__span"> 
                            <img src="https://exodus.b-cdn.net/exodus/geo/japon/img/menu/contacto.png" alt="" class="menu__image"/>
                        </span> contacto</a>
                </li>
                            ...
                            <div className="row">
                                <li className="col-md-3 menu__responsive-li">
                                    <ul>   
                                        ...
                                        <li class="menu__responsive-li">
                                            <a href="/exoticos" class="menu__responsive-a">
                                            <span class="menu__responsive-span--fits"></span> exoticos
                                            </a>
                                        </li>
                                    </ul>
                                </li>              
