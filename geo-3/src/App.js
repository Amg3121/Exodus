...
function Detail() {
  ...
  return (
    <>
      <div class="section-main-destination">
        <div class="container-fluid container__text--title padding__rem">
          <h1 class="h1-title-section"> {name} </h1>
        </div>
      </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <br />
              <iframe className="iframe-detail" title="detail" src={'https://www.megatravel.com.mx/tools/circuito.php?&txtColor=fff&aColor=fff&ahColor=fff&thBG=fff&thTxColor=fff&ff=3&viaje=' + detail} width="100%" height="1200" allowtransparency="true"> </iframe>
            </div>
          </div>
        </div>
      </section>
...
function App() {
  ...
  useEffect(() => {
    axios.get('https://2020.exodus.mx/api/agency/517').then(res => {
